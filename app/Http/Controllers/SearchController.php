...
class SearchController extends Controller
{
    ...
    public function go(Request $request) {
        ...
        if(!is_null($input['q'])) {
            ...
            $maiorTempo = array($data['time_01'], $data['time_02'], $data['time_03'], $data['time_04'], $data['time_05'], $data['time_06'], $data['time_07']);
            $maiorTempo = max($maiorTempo);
            ...
            foreach ($search as $searchResult) {
                ...
                if ( (ISO8601ToSeconds($videoInfo->contentDetails->duration)/60) <= $maiorTempo) {
            ...
            return view('search', array('msg' => "Erro campo busca não pode ser em branco!"));
        }
    }
}
